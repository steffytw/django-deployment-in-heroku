...
- Step 2 : The [Heroku Command Line Interface](https://devcenter.heroku.com/articles/heroku-cli) (CLI) makes it easy to create and manage your Heroku apps directly from the terminal. It’s an essential part of using Heroku.
